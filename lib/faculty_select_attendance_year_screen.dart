...
import 'package:first_app/faculty_take_attendance_screen.dart';
...
class FacultySelectAttendanceYearScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Mark Attendance', style: GoogleFonts.lato(fontWeight: FontWeight.bold)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Choose an allotted subject to take attendance.',
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => FacultyTakeAttendanceScreen(
                subjectId: subjectId,
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.how_to_reg, color: Colors.green.shade700, size: 28),
              ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No subjects allotted for attendance.',
