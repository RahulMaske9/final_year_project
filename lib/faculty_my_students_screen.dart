...
class MyStudentsScreen extends StatefulWidget {
  final String? year;
  final String? subjectName; // Added this parameter
  const MyStudentsScreen({super.key, this.year, this.subjectName});
...
class _MyStudentsScreenState extends State<MyStudentsScreen> {
  ...
  void initState() {
    ...
    if (widget.year != null) {
      ...
      // If no year is provided, show all students (e.g., for a subject)
  ...
  void _filterStudents() {
    ...
    setState(() {
      _filteredStudents = _allStudents.where((student) {
        bool matchesYear = widget.year == null || student.studentClass == widget.year;
  ...
  Widget build(BuildContext context) {
    final title = widget.year != null ? '${widget.year} Students' : '${widget.subjectName ?? ''} Students';
    return Scaffold(
      appBar: AppBar(
